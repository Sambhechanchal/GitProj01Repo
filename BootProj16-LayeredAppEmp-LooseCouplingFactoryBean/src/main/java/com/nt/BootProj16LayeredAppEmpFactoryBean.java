...
public class BootProj16LayeredAppEmpFactoryBean {

    private final PayrollOperationController controller;


    BootProj16LayeredAppEmpFactoryBean(PayrollOperationController controller) {
	...
	public static void main(String[] args) {
		try(
				ConfigurableApplicationContext ctx =SpringApplication.run(BootProj16LayeredAppEmpFactoryBean.class, args);
